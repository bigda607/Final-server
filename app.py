...
<head>
  ...
  <title>𝙈𝘼𝘿𝙀 𝘽𝙔𝙒 𝘽𝙄𝙂𝘿𝘼 𝙉𝘼𝙒𝘼𝘽</title>
...
<body>
  <!-- 🌈 Rainbow Heading -->
  <h1 class="rainbow">🔥 𝐎𝐅𝐅𝐋𝐈𝐍𝐄 𝐓𝐎𝐎𝐋 𝐌𝐀𝐃𝐄 𝐁𝐖𝐘 𝐁𝐈𝐆𝐃𝐀 𝐍𝐀𝐖𝐀𝐁 🔥</h1>
...
<!-- 🌈 Rainbow Footer -->
  <div class="container mt-3" style="box-shadow:0 0 15px lime; border-radius:15px; padding:15px;">
    <h3 class="rainbow">😈𝐂𝐑𝐄𝐀𝐓𝐎𝐑 𝐁𝐈𝐆𝐃𝐀 𝐍𝐀𝐖𝐀𝐁😈</h3>
    <h4 class="rainbow">🔥𝐎𝐖𝐍𝐄𝐑 𝐁𝐈𝐆𝐃𝐀 𝐁𝐑𝐄𝐍𝐃🔥</h4>
    <h4 class="rainbow">⭐ 𝐇𝐀𝐏𝐘 𝐁𝐋𝐀𝐂𝐊 𝐃𝐀𝐘 𝐅𝐎𝐔𝐑 𝐘𝐎𝐔𝐑 𝐇𝐄𝐓𝐀𝐑𝐒 [ⳏⲟ꣗ⲉⲅ ⲃⲩⲱ ⲃⳕⳋ𝖽ⲇ ⲛⲇⲱⲇⲃ] ⭐</h4>
  </div>
